...
namespace SmartTransportation
{
    ...
    public class Setting : ModSetting
    {
        ...
        [SettingsUITextInput]
        [SettingsUISection(CustomSection, CustomGroup)]
        public string name_Custom1 { get; set; } = "Custom Rule 1";

        [SettingsUISlider(min = 10, max = 90, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int target_occupancy_Custom1 { get; set; }

        [SettingsUISlider(min = 0, max = 30, step = 1, scalarMultiplier = 1, unit = Unit.kInteger)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int standard_ticket_Custom1 { get; set; }

        [SettingsUISlider(min = 0, max = 300, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_ticket_increase_Custom1 { get; set; }

        [SettingsUISlider(min = 0, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_ticket_discount_Custom1 { get; set; }

        [SettingsUISlider(min = -50, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_vahicles_adj_Custom1 { get; set; }

        [SettingsUISlider(min = -50, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int min_vahicles_adj_Custom1 { get; set; }

        // --- Custom Rule 2 ---
        [SettingsUITextInput]
        [SettingsUISection(CustomSection, CustomGroup)]
        public string name_Custom2 { get; set; } = "Custom Rule 2";

        [SettingsUISlider(min = 10, max = 90, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int target_occupancy_Custom2 { get; set; }

        [SettingsUISlider(min = 0, max = 30, step = 1, scalarMultiplier = 1, unit = Unit.kInteger)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int standard_ticket_Custom2 { get; set; }

        [SettingsUISlider(min = 0, max = 300, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_ticket_increase_Custom2 { get; set; }

        [SettingsUISlider(min = 0, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_ticket_discount_Custom2 { get; set; }

        [SettingsUISlider(min = -50, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_vahicles_adj_Custom2 { get; set; }

        [SettingsUISlider(min = -50, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int min_vahicles_adj_Custom2 { get; set; }

        // --- Custom Rule 3 ---
        [SettingsUITextInput]
        [SettingsUISection(CustomSection, CustomGroup)]
        public string name_Custom3 { get; set; } = "Custom Rule 3";

        [SettingsUISlider(min = 10, max = 90, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int target_occupancy_Custom3 { get; set; }

        [SettingsUISlider(min = 0, max = 30, step = 1, scalarMultiplier = 1, unit = Unit.kInteger)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int standard_ticket_Custom3 { get; set; }

        [SettingsUISlider(min = 0, max = 300, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_ticket_increase_Custom3 { get; set; }

        [SettingsUISlider(min = 0, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_ticket_discount_Custom3 { get; set; }

        [SettingsUISlider(min = -50, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_vahicles_adj_Custom3 { get; set; }

        [SettingsUISlider(min = -50, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int min_vahicles_adj_Custom3 { get; set; }

        // --- Custom Rule 4 ---
        [SettingsUITextInput]
        [SettingsUISection(CustomSection, CustomGroup)]
        public string name_Custom4 { get; set; } = "Custom Rule 4";

        [SettingsUISlider(min = 10, max = 90, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int target_occupancy_Custom4 { get; set; }

        [SettingsUISlider(min = 0, max = 30, step = 1, scalarMultiplier = 1, unit = Unit.kInteger)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int standard_ticket_Custom4 { get; set; }

        [SettingsUISlider(min = 0, max = 300, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_ticket_increase_Custom4 { get; set; }

        [SettingsUISlider(min = 0, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_ticket_discount_Custom4 { get; set; }

        [SettingsUISlider(min = -50, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_vahicles_adj_Custom4 { get; set; }

        [SettingsUISlider(min = -50, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int min_vahicles_adj_Custom4 { get; set; }

        // --- Custom Rule 5 ---
        [SettingsUITextInput]
        [SettingsUISection(CustomSection, CustomGroup)]
        public string name_Custom5 { get; set; } = "Custom Rule 5";

        [SettingsUISlider(min = 10, max = 90, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int target_occupancy_Custom5 { get; set; }

        [SettingsUISlider(min = 0, max = 30, step = 1, scalarMultiplier = 1, unit = Unit.kInteger)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int standard_ticket_Custom5 { get; set; }

        [SettingsUISlider(min = 0, max = 300, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_ticket_increase_Custom5 { get; set; }

        [SettingsUISlider(min = 0, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_ticket_discount_Custom5 { get; set; }

        [SettingsUISlider(min = -50, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int max_vahicles_adj_Custom5 { get; set; }

        [SettingsUISlider(min = -50, max = 100, step = 1, scalarMultiplier = 1, unit = Unit.kPercentage)]
        [SettingsUISection(CustomSection, CustomGroup)]
        [SettingsUIDisableByCondition(typeof(Setting), nameof(disable_Train))]
        public int min_vahicles_adj_Custom5 { get; set; }
    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.name_Custom1)), "Rule Name" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.target_occupancy_Custom1)), "Target Occupancy" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.standard_ticket_Custom1)), "Standard Ticket Price" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_ticket_increase_Custom1)), "Max. Ticket Increase" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_ticket_discount_Custom1)), "Max. Ticket Discount" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_vahicles_adj_Custom1)), "Max. Vehicle Increase" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.min_vahicles_adj_Custom1)), "Min. Vehicle Decrease" },

                { m_Setting.GetOptionDescLocaleID(nameof(Setting.target_occupancy_Custom1)), "Target occupancy for this rule. The mod will change ticket prices and vehicle frequency to try to reach this occupancy target." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.standard_ticket_Custom1)), "Standard ticket price. Vanilla value is 8." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_ticket_increase_Custom1)), "Maximum ticket increase. Ticket prices will increase at peak hours to generate more revenue and discourage cims to use transit at rush hours." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_ticket_discount_Custom1)), "Maximum ticket decrease. Ticket prices will decrease at off-peak hours to attract more passengers." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_vahicles_adj_Custom1)), "Increase the maximum allowed number of vehicles by this percentage." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.min_vahicles_adj_Custom1)), "Decrease the minimum allowed number of vehicles by this percentage." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.name_Custom2)), "Rule Name" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.target_occupancy_Custom2)), "Target Occupancy" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.standard_ticket_Custom2)), "Standard Ticket Price" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_ticket_increase_Custom2)), "Max. Ticket Increase" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_ticket_discount_Custom2)), "Max. Ticket Discount" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_vahicles_adj_Custom2)), "Max. Vehicle Increase" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.min_vahicles_adj_Custom2)), "Min. Vehicle Decrease" },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.name_Custom3)), "Rule Name" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.target_occupancy_Custom3)), "Target Occupancy" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.standard_ticket_Custom3)), "Standard Ticket Price" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_ticket_increase_Custom3)), "Max. Ticket Increase" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_ticket_discount_Custom3)), "Max. Ticket Discount" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_vahicles_adj_Custom3)), "Max. Vehicle Increase" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.min_vahicles_adj_Custom3)), "Min. Vehicle Decrease" },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.name_Custom4)), "Rule Name" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.target_occupancy_Custom4)), "Target Occupancy" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.standard_ticket_Custom4)), "Standard Ticket Price" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_ticket_increase_Custom4)), "Max. Ticket Increase" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_ticket_discount_Custom4)), "Max. Ticket Discount" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_vahicles_adj_Custom4)), "Max. Vehicle Increase" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.min_vahicles_adj_Custom4)), "Min. Vehicle Decrease" },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.name_Custom5)), "Rule Name" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.target_occupancy_Custom5)), "Target Occupancy" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.standard_ticket_Custom5)), "Standard Ticket Price" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_ticket_increase_Custom5)), "Max. Ticket Increase" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_ticket_discount_Custom5)), "Max. Ticket Discount" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_vahicles_adj_Custom5)), "Max. Vehicle Increase" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.min_vahicles_adj_Custom5)), "Min. Vehicle Decrease" },

                // Custom Rule 2
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.target_occupancy_Custom2)), "Target occupancy for this rule. The mod will change ticket prices and vehicle frequency to try to reach this occupancy target." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.standard_ticket_Custom2)), "Standard ticket price. Vanilla value is 8." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_ticket_increase_Custom2)), "Maximum ticket increase. Ticket prices will increase at peak hours to generate more revenue and discourage cims to use transit at rush hours." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_ticket_discount_Custom2)), "Maximum ticket decrease. Ticket prices will decrease at off-peak hours to attract more passengers." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_vahicles_adj_Custom2)), "Increase the maximum allowed number of vehicles by this percentage." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.min_vahicles_adj_Custom2)), "Decrease the minimum allowed number of vehicles by this percentage." },
                
                // Custom Rule 3
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.target_occupancy_Custom3)), "Target occupancy for this rule. The mod will change ticket prices and vehicle frequency to try to reach this occupancy target." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.standard_ticket_Custom3)), "Standard ticket price. Vanilla value is 8." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_ticket_increase_Custom3)), "Maximum ticket increase. Ticket prices will increase at peak hours to generate more revenue and discourage cims to use transit at rush hours." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_ticket_discount_Custom3)), "Maximum ticket decrease. Ticket prices will decrease at off-peak hours to attract more passengers." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_vahicles_adj_Custom3)), "Increase the maximum allowed number of vehicles by this percentage." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.min_vahicles_adj_Custom3)), "Decrease the minimum allowed number of vehicles by this percentage." },
                
                // Custom Rule 4
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.target_occupancy_Custom4)), "Target occupancy for this rule. The mod will change ticket prices and vehicle frequency to try to reach this occupancy target." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.standard_ticket_Custom4)), "Standard ticket price. Vanilla value is 8." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_ticket_increase_Custom4)), "Maximum ticket increase. Ticket prices will increase at peak hours to generate more revenue and discourage cims to use transit at rush hours." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_ticket_discount_Custom4)), "Maximum ticket decrease. Ticket prices will decrease at off-peak hours to attract more passengers." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_vahicles_adj_Custom4)), "Increase the maximum allowed number of vehicles by this percentage." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.min_vahicles_adj_Custom4)), "Decrease the minimum allowed number of vehicles by this percentage." },
                
                // Custom Rule 5
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.target_occupancy_Custom5)), "Target occupancy for this rule. The mod will change ticket prices and vehicle frequency to try to reach this occupancy target." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.standard_ticket_Custom5)), "Standard ticket price. Vanilla value is 8." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_ticket_increase_Custom5)), "Maximum ticket increase. Ticket prices will increase at peak hours to generate more revenue and discourage cims to use transit at rush hours." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_ticket_discount_Custom5)), "Maximum ticket decrease. Ticket prices will decrease at off-peak hours to attract more passengers." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_vahicles_adj_Custom5)), "Increase the maximum allowed number of vehicles by this percentage." },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.min_vahicles_adj_Custom5)), "Decrease the minimum allowed number of vehicles by this percentage." },
